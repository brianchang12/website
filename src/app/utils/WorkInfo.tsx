...
export const RivanInfo: WorkTileProps = {
  ...
  accomplishments: [
    "Signed off on 4 major release version of Rivan's Android and iOS app by performing manual and automated testing on mobile test matrix",
    ...
    "Documented the test plans on Confluence and Jira for over 5 different mobile by estimating cost resources and defining testing requirements",
...
export const TeslaInfo: WorkTileProps = {
  ...
  accomplishments: [
    ...
    "Scripted over a dozen Splunk queries to evaluate perform CPU usage and memory usage of vehicles across Tesla's fleet to evaluate the performance impact during OTA updates to ensure minimal Infotainment system degredation",
