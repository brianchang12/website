...
export default function IntroductionCard() {
  return (
    <motion.div viewport={{once: true}} whileInView={{x: 0}} initial={{x: -500}} transition={{duration: 1.2, type: "spring", delay: 0.3}} >
    <div className='intro-container'>
        <Image className="hero" src={hero} alt="brian's profile picture" />
        <Divider type='vertical' style={{borderWidth: "3px", height: "500px", color: "#5C8374"}} />
        <div className='about-me-container'>
            ...
            Throughout my early career, I have had the privilege to work at the University British Columbia&#39;s IT Department, an eletric vehicle start up Rivian, and even Tesla Motors.
            <br />
            <br />
            ...
            <div className='intro-btn-format'>
                <CustomButton height='auto' width='300px' text='Download My Resume' fontSize='15px'  backgroundColor="#040D12" padding='10px 0px'
                        borderRadius="20px" borderStyle='none' icon={<DownloadOutlined style={{color: "#c8d8e4"}} />} color='#c8d8e4'/>
            </div>
